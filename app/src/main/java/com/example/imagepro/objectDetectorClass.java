...
public class  objectDetectorClass {
    ...
    objectDetectorClass(AssetManager assetManager,String modelPath, String labelPath,int inputSize, String classification_mode,int classification_inputsize) throws IOException{
